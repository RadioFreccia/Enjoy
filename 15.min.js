/*! Repro 14 - RadiofrecciaNetworkenjoy */
(function ($) {
  "use strict";
  $(".repro14").append('<div class="player-wpr"><div class="blur"></div><div class="player-ctr"><div class="listeners fal fa-users"></div><div class="album-cover-wpr"><div class="social-share-wpr"><a href="" target="_blank" class="social-link social-link-facebook fab fa-facebook.f animated" id="aface"></a> <a href="" target="_blank" class="social-link social-link-twitter fab fa-twitter animated" id="twitter"></a></div><div class="album-cover animated"></div></div><div class="track-info-wpr"><div class="track-info-ctr"><div class="marquee"> <span class="artist-name animated"></span><span> </span><span class="songtitle animated"></span></div></div></div><div class="ppBtn play-btn fal fa-circle"></div><div class="servertitle"></div></div><div class="icons-left-wpr"><div class="icons-left icons-history fal fa-history"></div></div><div class="icons-right-wpr"><div class="icons-right icons-volume fal fa-volume.up"></div><div class="icons-right icons-volumeM fal fa-volume"></div></div> <input class="volume-slider" type="range" min="0" max="100" step="0.10" value="" autocomplete="off"><div class="history-wpr nodisplay"><div class="history-title">Temi anteriori</div></div></div>');
  $.fn.repro14 = function (options) {
    var settings = $.extend({
      // Default Settings
      URL: "",
      version: "2",
    ...
    function getCover(artist, title) {
      ...
      var url = "https://itunes.apple.com/search?term==" + artist + "&media=music&limit=1";
      $.ajax({
        dataType: 'jsonp',
        url: url,
        success: function (data) {
